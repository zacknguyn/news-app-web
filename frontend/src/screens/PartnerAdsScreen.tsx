...
export const PartnerAdsScreen: React.FC = () => {
  ...
  return (
    <main className="app-page mx-auto min-h-[calc(100svh-4rem)] max-w-[1280px] text-app-text">
      <header className="mb-8 flex flex-col justify-between gap-5 md:flex-row md:items-end"><div><p className="mb-3 font-mono text-[10px] font-semibold uppercase tracking-widest text-app-action">Sponsor intelligence</p><h1 className="text-[34px] font-bold tracking-tight text-app-heading md:text-5xl">Campaign Dashboard</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-app-muted">Manage sponsored placements and approval status across Tourane News Intelligence.</p></div><button type="button" onClick={() => { resetForm(); setIsModalOpen(true); }} className="inline-flex items-center justify-center gap-2 rounded-lg bg-app-action px-5 py-3 text-sm font-semibold text-app-on-action hover:bg-app-action-hover"><Plus className="h-4 w-4" />New campaign</button></header>
