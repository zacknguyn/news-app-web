  ...
  return (
    <div className="app-page mx-auto max-w-[1280px]">
      <div className="grid gap-8 lg:grid-cols-[13rem_minmax(0,1fr)]">
        ...
        <main className="min-w-0"><header className="mb-10 flex flex-col justify-between gap-6 md:flex-row md:items-end"><div><p className="mb-3 text-[10px] font-semibold uppercase tracking-wider text-app-muted">Topics</p><h1 className="text-[34px] font-bold tracking-tight text-app-heading md:text-5xl">Explore Topics</h1><p className="mt-3 max-w-xl text-sm leading-6 text-app-muted">Follow topics to curate your feed and discover discussions.</p></div><SearchInput id="topics-search" value={query} onChange={e => setQuery(e.target.value)} onClear={() => setQuery('')} placeholder="Search topics" aria-label="Search topics" containerClassName="md:w-72" /></header>
