...
const plans: Array<{
  ...
  },
  {
    ...
    bestFor: 'Readers who want advanced saves and contributor alerts.',
    features: [
  ...
  return (
    <div className="app-page mx-auto max-w-[1280px]">
      <header className="mb-14 text-center">
        <p className="mb-4 text-[11px] font-semibold uppercase tracking-wider text-app-muted">Unrivaled intelligence</p>
